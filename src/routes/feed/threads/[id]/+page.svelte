<script lang="ts">
  ...
  import {deriveEvent, ANMORE_RELAY} from "@app/core/state"
  import {setChecked} from "@app/util/notifications"

  const {id} = $page.params as MakeNonOptional<typeof $page.params>
  const url = ANMORE_RELAY // Always use relay.anmore.me for root routes
